...
export const requests = pgTable("requests", {
  ...
  actionId: integer("actionId").references(() => actions.id, { onDelete: "set null" }),
  eventId: integer("eventId").references(() => events.id, { onDelete: "set null" }),
  mediaPointId: integer("mediaPointId").references(() => mediaPoints.id, { onDelete: "set null" }),
  mediaCampaignId: integer("mediaCampaignId").references(() => mediaCampaigns.id, { onDelete: "set null" }),
  createdAt: timestamp("createdAt", { withTimezone: true }).defaultNow().notNull(),
  updatedAt: timestamp("updatedAt", { withTimezone: true }).defaultNow().notNull(),
  completedAt: timestamp("completedAt", { withTimezone: true }),
});
