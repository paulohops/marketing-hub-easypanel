...
export const supplierOfferingKindEnum = pgEnum("supplier_offering_kind", ["product", "service", "media", "action", "event", "other"]);
...
export const providers = pgTable("providers", {
  ...
  headquartersCityId: integer("headquartersCityId").references((): AnyPgColumn => cities.id, { onDelete: "set null" }),
