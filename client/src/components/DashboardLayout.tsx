  ...
  },
  {
    ...
    items: [
      ...
      { label: "Financeiro", path: "/financeiro", icon: Landmark, permission: "finance.read" },
      {
        ...
        children: [
          { label: "Território", path: "/cadastros/territorio", icon: MapPinned, permission: "settings.read" },
          { label: "Parceiros", path: "/cadastros/parceiros", icon: Handshake, permission: "settings.read" },
          { label: "Operação", path: "/cadastros/operacao", icon: Settings2, permission: "settings.read" },
          { label: "Categorias", path: "/cadastros/categorias", icon: Database, permission: "settings.read" },
          { label: "Financeiro", path: "/cadastros/financeiro", icon: Landmark, permission: "settings.read" },
          { label: "Modelos", path: "/cadastros/modelos", icon: FileSpreadsheet, permission: "settings.read" },
        ],
      },
    ],
  },
