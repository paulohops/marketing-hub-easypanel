  ...
  },
  {
    ...
    items: [
      ...
      { label: "Financeiro", path: "/financeiro", icon: Landmark, permission: "finance.read" },
      {
        ...
        children: [
          { label: "Território", path: "/cadastros/operacionais#territorio", icon: MapPinned, permission: "settings.read" },
          { label: "Parceiros", path: "/cadastros/operacionais#parceiros", icon: Handshake, permission: "settings.read" },
          { label: "Operação", path: "/cadastros/operacionais#operacao", icon: Settings2, permission: "settings.read" },
          { label: "Categorias", path: "/cadastros/operacionais#categorias", icon: Database, permission: "settings.read" },
          { label: "Financeiro", path: "/cadastros/operacionais#financeiro", icon: Landmark, permission: "settings.read" },
          { label: "Modelos", path: "/cadastros/operacionais#modelos", icon: FileSpreadsheet, permission: "settings.read" },
        ],
      },
    ],
  },
