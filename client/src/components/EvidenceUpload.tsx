...
import { Download, FileText, Loader2, Paperclip, Play, Video, Volume2 } from "lucide-react";
...
export default function EvidenceUpload({ entityType, entityId, regionalId, canWrite = false, variant = "default", onUploadComplete }: { entityType: EntityType; entityId: number; regionalId?: number | null; canWrite?: boolean; variant?: "default" | "side" | "gallery"; onUploadComplete?: (url: string) => void }) {
