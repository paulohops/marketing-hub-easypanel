...
const definitions = {
  ...
  "midias-externas": { permission: "media.read", eyebrow: "Ativações de rua", title: "Mídias externas", description: "Gerencie carros de som, panfletagem e outros formatos de divulgação externa.", icon: Megaphone, resources: [], accent: "var(--primary)" },
