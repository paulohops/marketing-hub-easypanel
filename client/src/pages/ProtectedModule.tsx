...
const definitions = {
  ...
  solicitacoes: { permission: "requests.read", eyebrow: "Gestão integrada", title: "Solicitações", description: "Registre, encaminhe e acompanhe solicitações de ações, eventos, mídias e demandas administrativas.", icon: Inbox, resources: [], accent: "var(--primary)" },
