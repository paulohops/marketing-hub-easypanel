...
const definitions = {
  ...
  "midias-graficas": { permission: "media.read", eyebrow: "Canais e cobertura", title: "Mídias gráficas", description: "Planeje e acompanhe outdoors, painéis e superfícies gráficas.", icon: Megaphone, resources: [], accent: "var(--primary)" },
  "midias-audio-video": { permission: "media.read", eyebrow: "Canais e cobertura", title: "Áudio e vídeo", description: "Acompanhe rádios, TVs, spots e horários de veiculação.", icon: Megaphone, resources: [], accent: "var(--primary)" },
