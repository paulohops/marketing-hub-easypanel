...
import { AlertCircle, CalendarClock, CheckCircle2, Clock3, Inbox, Loader2, Pencil, Plus, Search, Trash2, UserRound, X } from "lucide-react";
...
const emptyForm: RequestFormState = { title: "", description: "", requestType: "action", status: "submitted", priority: "normal", assignedToUserId: "", regionalId: "", cityId: "", requestedForDate: "", dueDate: "", statusNote: "" };
