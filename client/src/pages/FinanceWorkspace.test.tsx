...
const trpcStub = vi.hoisted(() => ({
  useUtils: () => ({ finance: { listInvoices: { invalidate: vi.fn() }, listSupplierContracts: { invalidate: vi.fn() } }, budgets: { annualSummary: { invalidate: vi.fn() }, listBudgets: { invalidate: vi.fn() }, summary: { invalidate: vi.fn() }, listCosts: { invalidate: vi.fn() } } }),
