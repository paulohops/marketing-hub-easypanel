...
import { ArrowLeft, CalendarDays, CalendarClock, CheckCircle2, ChevronLeft, ChevronRight, ExternalLink, FileAudio, History, MapPin, Paperclip, Pencil, Plus, RefreshCw, Route, Save, Signal, UserRound, Volume2 } from "lucide-react";
