...
const modules = [
  ...
  { title: "Operações unificadas", description: "Trade, mídia, eventos, alvará e debriefing", icon: CalendarClock, href: "/operacoes", color: "bg-accent text-accent-foreground" },
];
    ...
    <div className="mx-auto max-w-[1480px]">
      <section className="cluster-grid relative overflow-hidden rounded-[22px] bg-primary px-6 py-7 text-white shadow-[0_16px_42px_rgba(14,114,59,0.18)] sm:px-8 sm:py-9">
        ...
        <div className="relative flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
          ...
          <Button onClick={() => setLocation("/operacoes")} className="h-10 rounded-xl bg-sidebar-primary px-4 text-xs font-bold text-white hover:bg-accent-foreground"><Plus className="mr-1.5 h-4 w-4" /> Nova operação</Button>
        </div>
      </section>
