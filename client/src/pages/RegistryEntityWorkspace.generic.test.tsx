...
afterEach(() => { cleanup(); window.history.replaceState({}, "", "/cadastros/servicos"); vi.clearAllMocks(); vi.restoreAllMocks(); });

describe("cadastros genéricos", () => {
  ...
  it("seleciona registros visíveis e confirma a exclusão em massa", () => {
    ...
    expect(setup.mocks.deleteRegistries).toHaveBeenCalledWith({ kind: "service", ids: [4] });
  });
});
