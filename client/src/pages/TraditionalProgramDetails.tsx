  ...
  const submit = (event: FormEvent) => {
    ...
    const schedules: TraditionalSchedulePayload[] = form.schedules
      ...
      .flatMap((item): TraditionalSchedulePayload[] => {
        const base = { programName: item.programName.trim(), notes: item.notes?.trim() || undefined, startsAt: item.startsAt, endsAt: item.endsAt };
