...
export default function TraditionalProgramDetails({ mediaPointId }: { mediaPointId: number }) {
  ...
  <div id="traditional-point-debrief" className="mt-5"><OperationalDebriefing value={operationalDebrief} onChange={setOperationalDebrief} onSave={submitDebrief} pending={savePointDebrief.isPending} canWrite={canWrite} title="Debriefing do programa audiovisual" summaryLabel="História e resultado do programa" /></div>
  </main>;
}
