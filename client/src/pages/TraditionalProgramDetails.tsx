...
import { ArrowLeft, CalendarDays, CalendarClock, CheckCircle2, ChevronLeft, ChevronRight, ExternalLink, FileAudio, History, MapPin, Paperclip, Pencil, Plus, Radio, RefreshCw, Route, Save, Signal, UserRound } from "lucide-react";
  ...
  return <main className="mx-auto max-w-[1480px] space-y-5">
    ...
    <header className="rounded-2xl border border-border bg-card p-6 shadow-sm">
      <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
        ...
        {canWrite && <div className="flex w-full flex-wrap items-center justify-end gap-2 xl:w-auto xl:shrink-0">
          ...
          <OperationalStatusDropdown id="traditional-program-status" value={currentStatus} options={pointStatusOptions} onChange={openStatus} disabled={updatePointStatus.isPending} className="min-w-[8.25rem] px-2 text-xs" />
    ...
    <div className="grid items-start gap-5 lg:grid-cols-[minmax(260px,0.78fr)_minmax(0,1.42fr)]">
      ...
      <section className="min-w-0 space-y-5">
        ...
        <TraditionalProgrammingCalendar campaigns={calendarCampaigns} onOpenCampaign={campaignId => setLocation(`/midias/audiovisual/veiculacao/${campaignId}`)} />
      </section>
    </div>
