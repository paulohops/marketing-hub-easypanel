...
const trpcStub = vi.hoisted(() => {
  ...
  const overviewData = {
    providers: [], regionals: [], cities: [{ id: 3, name: "Belo Horizonte", state: "MG", active: true }], stores: [],
    ...
    partners: [], commercialSupervisors: [], serviceTypes: [{ id: 4, name: "Panfletagem" }], mediaTypes: [{ id: 5, name: "Outdoor" }], actionTypes: [], eventTypes: [], financialCategories: [], supplierOfferings: [{ id: 9, supplierId: 7, name: "Folder A5", unit: "milheiro", unitPrice: "450.00" }],
